            ...
            <Card className="p-4 mb-5" style={{ backgroundColor: "#F5F5F5" }}>
                ...
                <Form>
                    ...
                    {[...Array(numPeople)].map((_, index) => (
                        <Row key={index} className="mb-3 d-flex align-items-stretch" style={{ paddingTop: "10px" }}>
                            {[
                                ...
                                { label: "IMB (Bruto)", placeholder: "IMB (Bruto)", type: "number" },
                                { label: "IMN (Neto)", placeholder: "IMN (Neto)", type: "number" }
                            ].map((field, idx) => (
                                <Col key={idx} className="d-flex">
                                    <div className="p-2 border rounded flex-fill d-flex flex-column justify-content-between" style={{ backgroundColor: "#F5F5F5" }}>
                    ...
                    <Form.Group className="mt-4">
                        <Form.Label style={{ color: "#4F46E5", maxWidth: "100px"}}>Ingreso total:</Form.Label>
